...
const publicRoutes = [
  ...
  { path: '/wholesale', expectedText: 'Kurumsal & B2B Çözümleri' },
  ...
  { path: '/about', expectedText: 'Felsefemiz & Atölyemiz' },
  { path: '/contact', expectedText: 'İletişim & Showroom' },
  { path: '/faq', expectedText: 'Sıkça Sorulan Sorular' },
  { path: '/policies/shipping-returns', expectedText: 'Kargo, Teslimat & İade Bilgilendirmesi' },
  { path: '/policies/privacy-kvkk', expectedText: 'Gizlilik Politikası & KVKK Aydınlatma Metni' },
  { path: '/policies/terms', expectedText: 'Kullanım Şartları & Mesafeli Sözleşme Genel İlkeleri' },
