...
1. Consult [`docs/ADMIN.md`](file:///D:/freelance/vazo-website/docs/ADMIN.md) for full module blueprints and CRUD contracts.
2. Enforce the **Functional or Explicitly Disabled** rule: never create fake interactive buttons that silently do nothing.
3. Consult [`docs/SECURITY.md`](file:///D:/freelance/vazo-website/docs/SECURITY.md): never expose server secrets or store sensitive credentials in browser client state.
