  ...
  groups: [
    {
      ...
      links: [
        ...
        { label: 'Minimum Sipariş (MOQ) Koşulları', href: '/wholesale/moq' },
        { label: 'Numune Seti Siparişi', href: '/wholesale/samples' },
        { label: 'Katalog & Fiyat Listesi İndir (PDF)', href: '/wholesale/catalog' },
      ],
    },
    {
      title: 'Sektörel Projeler',
      links: [
        { label: 'İç Mimarlar & Tasarım Ofisleri', href: '/wholesale/architects' },
        { label: 'Otel, Restoran & Kafe (HORECA)', href: '/wholesale/hospitality' },
        { label: 'Butik Konsept Mağazalar', href: '/wholesale/retailers' },
        { label: 'Kurumsal VIP Hediye Projeleri', href: '/wholesale/corporate' },
        { label: 'Özel Ölçü & Sır Üretimi', href: '/wholesale/custom' },
      ],
    },
    {
      title: 'Süreç & Başvuru',
